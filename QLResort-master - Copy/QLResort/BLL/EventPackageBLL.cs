...
using QLResort.DAL.EventPackageDAL;
using System;
...
{
    public class EventPackageBLL
    {
        private readonly EventPackageDAL eventPackageDAL = new EventPackageDAL();

        public OperationResult<List<EventPackage>> GetEventPackages(string maGoiSK = null, string loaiSuKien = null,
            string maCN = null, bool? isGoiMacDinh = null, bool? isActive = null)
        {
            var dalResult = eventPackageDAL.GetEventPackages(maGoiSK, loaiSuKien, maCN, isGoiMacDinh, isActive);
