    ...
    public partial class frmPromotion : AppBaseForm
    {
        ...
        private void lvPromotions_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (item.Tag is Promotion prom)
            {
                ...
                // Select comboboxes
                SelectComboBox(cbMaCN, prom.MaCN);
                SelectComboBox(cbMaLP, prom.MaLP);
                SelectComboBox(cbMaPhong, prom.MaPhong);
                SelectComboBox(cbMaLKH, prom.MaLKH);
        ...
        private void SelectComboBox(ComboBox cb, string value)
        {
            ...
            for (int i = 0; i < cb.Items.Count; i++)
            {
                ...
                if (item.MaCN == value || item.MaLP == value || item.MaPhong == value || item.MaLKH == value)
                {
                    cb.SelectedIndex = i;
                    return;
                }
