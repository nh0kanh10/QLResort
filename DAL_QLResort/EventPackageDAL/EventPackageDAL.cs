...
namespace DAL_QLResort.EventPackageDAL
{
    public class EventPackageDAL
    {
        private readonly FastQuery fastQuery = new FastQuery();

        public OperationResult<DataTable> GetEventPackages(string maGoiSK = null, string maSK = null,
        ...
        public OperationResult<bool> Insert(EventPackage package)
        {
            try
            {
                SqlParameter[] parameters = new SqlParameter[]
                {
                    ...
                    SqlParameterHelper.Create("@MaSK", package.MaSK),
