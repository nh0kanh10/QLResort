...
namespace DAL_QLResort.Guest_F
{
    public class GuestDAL
    {
        ...
        public OperationResult<DataTable> GetGuest(string maKH = null, string tenKH = null, string gioiTinh = null, string sdt = null, string id = null, string maLoaiKH = null, bool? isActive = null)
        {
            try
            {
                SqlParameter[] p =
                {
                    ...
                    new SqlParameter("@HoTen", (object)tenKH ?? DBNull.Value),
                    new SqlParameter("@GioiTinh", (object)gioiTinh ?? DBNull.Value),
                    new SqlParameter("@SDT", (object)sdt ?? DBNull.Value),
                    new SqlParameter("@IDNumber", (object)id ?? DBNull.Value),
                    new SqlParameter("@MaLKH", (object)maLoaiKH ?? DBNull.Value),
        ...
        public OperationResult<bool> AddGuest(GuestM guest)
        {
            try
            {
                SqlParameter[] p =
                {
                    ...
                    new SqlParameter("@CreateBy", (object)guest.CreatedBy ?? DBNull.Value),
        ...
        public OperationResult<bool> UpdateGuest(GuestM guest)
        {
            try
            {
