    ...
    public partial class test : Form
    {
        ...
        private void test_Load(object sender, EventArgs e)
        {
            ...
            foreach (var roomData in listRoomsFromDatabase)
            {
                ...
                roomCard.SetData(roomData);

                if (roomData.TrangThai?.ToLower() == "trống" || roomData.TrangThai?.ToLower() == "available")
                    roomCard.BackColor = Color.LightGreen;
                else
                    roomCard.BackColor = Color.LightCyan;
