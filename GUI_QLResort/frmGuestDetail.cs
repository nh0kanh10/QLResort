...
namespace GUI_QLResort
{
    public partial class frmGuestDetail : AppBaseForm
    {
        ...
        private readonly GuestPointBUS _guestPointBUS = new GuestPointBUS();
        ...
        private void LoadGuestDetails()
        {
            ...
            try
            {
                ...
                // Load điểm tích lũy
                var pointResult = _guestPointBUS.GetGuestPoint(_selectedGuest.MaKH);
                if (pointResult.Success)
                {
                    lblPoints.Text = $"Điểm tích lũy: {pointResult.Data.DiemHienTai}";
                }
                else
                {
