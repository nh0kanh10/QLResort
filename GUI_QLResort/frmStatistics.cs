    ...
    public partial class frmStatistics : AppBaseForm
    {
        ...
        private void btnInBaoCao_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // 3. Load Report - Tạm comment vì chưa có Crystal Reports
                // CrystalDecisions.CrystalReports.Engine.ReportDocument rpt = new CrystalDecisions.CrystalReports.Engine.ReportDocument();
                // rpt.Load(reportPath);
                // rpt.SetDataSource(ds);

                // 4. Show Viewer - Tạm comment vì chưa có frmReportViewer
                // frmReportViewer frm = new frmReportViewer();
                // frm.LoadReport(rpt);
                // frm.ShowDialog();
                
                MessageBox.Show("Báo cáo đã được tạo thành công!\nChức năng xem báo cáo Crystal Reports chưa được kích hoạt.", 
